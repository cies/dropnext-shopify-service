...
dependencies {
  ...
  implementation(libs.kotlinxCoroutinesSlf4j) // `MDCContext`, behind `withMdcEntries`: what a handler or the warm-up adds to the MDC survives suspensions; Ktor's call logging already ships it
